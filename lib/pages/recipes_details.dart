...
class _RecipesDetailsPageState extends State<RecipesDetailsPage> {
  ...
  Future<void> _toggleFavorite(BuildContext context) async {
    ...
    try {
      await context.read<RecipeNotifier>().toggleFavorite(widget.recipes);
      await context.read<FavoriteNotifier>().loadFavorites();
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: SvgPicture.asset(
                        widget.recipes.isFavorite
                            ? 'assets/icons/HeartSolid.svg'
                            : 'assets/icons/Heart.svg',
                        color: widget.recipes.isFavorite
                            ? Colors.red
                            : Colors.grey,
                      ),
                    )
